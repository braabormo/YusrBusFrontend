...
import {
  ...
  refreshTrips,
  setCurrentTripsPage,
} from "../logic/tripSlice";
import {
  openTripChangeDialog,
  openTripDeleteDialog,
  setIsTripChangeDialogOpen,
  setIsTripDeleteDialogOpen,
} from "../logic/tripDialogSlice";
      ...
      ChangeDialog={
        <ChangeTripDialog
          ...
          onSuccess={(data, mode) => {
            ...
            if (mode === "create") dispatch(setIsTripChangeDialogOpen(false));
          }}
        />
      }
    ></CrudPage>
