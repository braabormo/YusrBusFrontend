...
}: ChangeDepositDialogProps) 
{
  ...
  const { formData, setFormData, handleChange, getError, isInvalid, validate, errorInputClass, clearError } = useEntityForm<Deposit>(entity, validationRules);
  const { fileInputRef, handleFileChange, handleRemoveFile, handleDownload, showFilePreview, getFileSrc } = useStorageFile(
    setFormData,
    "image"
  );
          ...
          <div className="flex-1 w-full space-y-2">
            ...
            <FieldsSection columns={2}>
              ...
              <TextField
                ...
                onChange={(e) => { handleChange("sender", e.target.value); clearError("sender"); }}
              />
              ...
              <PhoneField
                ...
                onChange={(e) => { handleChange("senderPhone", e.target.value); clearError("senderPhone"); }}
              />
              ...
              <TextField
                ...
                onChange={(e) => { handleChange("recipient", e.target.value); clearError("recipient"); }}
              />
              ...
              <PhoneField
                ...
                onChange={(e) => { handleChange("recipientPhone", e.target.value); clearError("recipientPhone"); }}
              />
              ...
              <NumberField
                ...
                onChange={(val) => { handleChange("amount", val); clearError("amount"); }}
              />
